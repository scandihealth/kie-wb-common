...
//        }} ) );
    ...
    public void onSearchClick( final ClickEvent e ) {
        ...
        if ( Boolean.TRUE.equals( isValidForPrimarySectorReports.getValue() ) ) {
            metadata.put( IS_VALID_FOR_PRIMARY_SECTOR_REPORTS, isValidForPrimarySectorReports.getValue() );
        }

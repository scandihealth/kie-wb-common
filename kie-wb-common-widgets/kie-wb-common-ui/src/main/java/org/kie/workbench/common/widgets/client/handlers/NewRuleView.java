...
@ApplicationScoped
public class NewRuleView extends BaseModal implements NewRulePresenter.View {
    ...
    private NewRulePresenter presenter;
    ...
    @Override
    public void init( final NewRulePresenter presenter ) {
    ...
    @Override
    public void setActiveHandler( final NewRuleHandler handler ) {
